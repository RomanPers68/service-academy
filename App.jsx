  ...
  return (
    <div style={T.app}>
      ...
      <div style={T.phone}>
        ...
        {screen === "assistant" && <Suspense fallback={<ScreenLoader T={T} />}><AssistantScreen T={T} a11y={a11y} profile={profile} onBack={() => navigate(prevScreen || "roleSelect")} onNavigate={(dest) => { const ok = ["sos","glossary","leaderboard","profile","daily","checklist","reference","stats","candidate","guestbook","mentor"]; if (ok.includes(dest)) navigate(dest); }} /></Suspense>}
