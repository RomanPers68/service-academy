...
//   2. Добавить экран чата в приложение (экран чата — ui/assistant.jsx)
...
4. Не обсуждай темы вне сервиса, меню, бара и стандартов ресторана.
5. По бару опирайся на стандарты академии: пролив только через джиггер, стир для прозрачных
   напитков и шейк для всего с соком и сахаром, лёд — ингредиент (совок снаружи, никогда бокалом),
   перебравшему гостю отказывают тихо и с водой, о стоп-листе говорят честно и сразу с заменой.`;
