...
export const GLOSSARY = [
  ...
  { term: "Первое впечатление", def: "Вывод о ресторане, который гость делает в первые секунды — ещё до сервиса, по чистоте, свету, виду и поведению сотрудников. Управляет им СПГ." },
  { term: "Лояльность", def: "Готовность гостя возвращаться снова и рекомендовать ресторан. Растёт там, где гость чувствует заботу, а не просто отсутствие ошибок." },
];
