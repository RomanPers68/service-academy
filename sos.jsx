...
const SOS_CARDS = [
  ...
  },
  {
    ...
    lines: [
      ...
      "✅ Нашёл стекло или осколок — сразу убери блюдо, честно извинись, принеси новое.",
  ...
  },
  {
    ...
    lines: [
      ...
      "🚫 Явно пьяному алкоголь больше не подаём — вежливо, без спора.",
      "✅ Предложи воду и еду, замедли темп, позови менеджера.",
