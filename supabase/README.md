...
| 21 | `supabase-stage18-check-functions.sql` | Чек-листы (переходник _sa_identity для uuid), полная проверка всех функций базы, заведения в редакторе контента. Можно запускать в любой момент |
| 22 | `supabase-stage19-mood-summary.sql` | Сводка настроения команды: неоднозначное is_admin (нашёл этап 18) |
