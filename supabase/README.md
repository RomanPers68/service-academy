...
`whoami_txt(p_token)` — переходник из этапа 11c; этапы 15 и 16 сами создают его, если
его нет. И в конце каждого этапа — `notify pgrst, 'reload schema';`, иначе приложение
