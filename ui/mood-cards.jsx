...
export function moodPalette(a11y) {
  return a11y
    ? { cardBg:"rgba(250,242,222,0.55)", border:"rgba(139,106,48,0.30)", top:"rgba(255,252,240,0.9)", shadow:"inset 0 0 20px rgba(255,250,235,0.5), inset 0 1px 0 rgba(255,252,240,0.9), 0 3px 12px rgba(120,90,30,0.10)", text:INK, muted:BROWN, dim:"#7A654C", gold:"#7A5D2A", green:GREEN_DARK, barTop:GOLD, barBot:"#7A5D2A" }
    : { cardBg:"rgba(255,250,238,0.05)", border:"rgba(255,255,255,0.13)", top:"rgba(255,255,255,0.20)", shadow:"inset 0 0 20px rgba(255,248,230,0.06), inset 0 1px 0 rgba(255,255,255,0.10), 0 5px 16px rgba(0,0,0,0.32)", text:"#EFE4C8", muted:"#9A8C74", dim:"#928A7C", gold:GOLD, green:GREEN, barTop:"#E8C87A", barBot:GOLD };
}
...
export function StreakCard({ streak, a11y }) {
  const C = a11y
    ? { gold:"#7A5D2A", num:"#9A6B1E", text:INK, muted:BROWN, dim:"#7A654C",
    ...
    : { gold:GOLD, num:"#EBCF8E", text:"#EFE4C8", muted:"#9A8C74", dim:"#928A7C",
