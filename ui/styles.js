...
export const A = {
  ...
  modCard:    { ...S.modCard, background:"rgba(250,242,222,0.55)", border:"1px solid rgba(139,106,48,0.35)", boxShadow:"inset 0 0 22px rgba(255,255,255,0.5), inset 0 1px 0 rgba(255,255,255,0.85), 0 3px 14px rgba(120,90,30,0.10)" },
